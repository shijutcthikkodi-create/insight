...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleWhatsAppRedirect = () => {
    const cleanPhone = phone.replace(/\D/g, '').slice(-10);
    const readyMessage = `*Insight Subscription Request*
-----------------------------
Name: ${name.trim()}
Mobile: ${cleanPhone}
Hardware Hash: ${browserDeviceId}
-----------------------------
Hi Support, I would like to subscribe to the Insight Institutional Terminal. Please provide my Access Key and instructions.`;
